        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-8">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl lg:text-3xl font-bold text-white mb-8 font-display">
                Contact Information
              </h2>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="space-y-1">
                            {info.details.map((detail, idx) => (
                              <p key={idx} className="text-gray-300 font-accent">
                                {detail}
                              </p>
                            ))}
                          </div>
            ...
            >
              <h3 className="text-lg font-semibold text-white mb-6 font-display flex items-center">
                <ChatBubbleLeftRightIcon className="w-6 h-6 mr-2 text-amber-400" />
              ...
              <div className="grid grid-cols-4 gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    key={index}
                    href={social.url}
                    className="w-14 h-14 bg-gradient-to-br from-purple-600 to-purple-800 hover:from-amber-500 hover:to-amber-600 rounded-xl flex items-center justify-center text-white transition-all duration-300 shadow-lg hover:shadow-xl"
            ...
            >
              <div className="bg-gray-800 rounded-xl h-64 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <button className="mt-4 text-amber-400 hover:text-amber-300 font-semibold underline font-display transition-colors">
                    Get Directions
                  </button>
                </div>
              </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="glass-effect-strong rounded-3xl p-6 lg:p-8 border-divine">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm font-accent">
